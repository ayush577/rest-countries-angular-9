...
export class RestcountriesService {
  ...
  rootUrl = "https://restcountries.eu/rest/v2";

  getCountriesList() {
    return this.http.get<Cardcountries[]>(
      `${this.rootUrl}/all?fields=name;region;population;flag;capital`
    );
  }

  getFilterList() {
    return this.http.get<continents[]>(`${this.rootUrl}/all?fields=region`);
  }
